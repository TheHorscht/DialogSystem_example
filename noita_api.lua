...
---@param array_name string
---@param type_stored_in_vector string
---@return table<int|number|string, nil>|nil
...
---Converts 'material_from' to 'material_to' everwhere in the game world, replaces 'material_from_type' to 'material_to_type' in the material (CellData) global table, and marks 'material_from' as a "Transformed" material. Every call will add a new entry to WorldStateComponent which serializes these changes, so please call sparingly. The material conversion will be spread over multiple frames. Use CellFactory_GetType() to convert a material name to material type.
